    ...
    <section>
        @if ($contactContent)
            <div class="container-fluid position-relative rounded-bottom mb-3"
                style="background-image: url('{{ asset('pages/' . $contactContent->img_url) }}'); background-size: cover; background-position: center center; background-repeat: no-repeat; width: 100%; height: 400px; margin-bottom: 0.8rem;">
                ...
                <div class="row position-relative z-index-1">
                    <div class="col-md-12 ms-5 w-50">
                        <h3 class="text-white" style="margin-top: 4rem">{{ $contactContent->title }}</h3>
                        <p class="text-white mt-3">{{ $contactContent->description }}</p>
                    </div>
                </div>
            </div>
        @endif
